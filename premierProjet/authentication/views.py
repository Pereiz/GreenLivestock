...
class AccountUserViewset(UserViewSet):
    ...
    def perform_create(self, serializer):
        ...
        activation_message = f"Salut  {user.username}.\n\nVous recevez cet message car vous venez de vous inscrire sur l'application comission validation, veuillez activer votre comptre en utilisant le code suivant :\n\n{activation_code}"
...
class UserActivationView(APIView):
    ...
    def get (self, request, email, code):
        ...
        if user_activation.activation_code == code:
            ...
            activation_message = f"Salut {user.username}\n\nVotre compte a été crée et activé avec succès sur comission validation !"
